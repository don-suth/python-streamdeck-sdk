...
def image_file_to_base64(file_path: Path) -> str:
	"""
	Converts an image file to a Streamdeck-compatible base64 encoded string.
	"""
...
def image_bytes_to_base64(obj: bytes, image_mime: str) -> str:
	"""
	Converts image bytes and a mime-type into a Streamdeck-compatible base64 encoded string,
	"""
	prefix = f"data:{image_mime};base64,"
